...
public class insertResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String  erMaths = jTextField2.getText();
        String  dsa = jTextField3.getText();
        String  aiMl = jTextField4.getText();
        String  webDev = jTextField5.getText();
        ...
        try{
             ...
             if(rs.next()){
                 st.executeUpdate("insert into result values('"+rollNo+"','"+erMaths+"','"+dsa+"','"+aiMl+"','"+webDev+"','"+dbms+"')");
